#!/usr/bin/env python
"""
Create Finance_MonthlyTransactions stored procedure
This SP is used for filtering transactions by month
"""
...
def create_finance_monthlytransactions_sp():
    """Create the Finance_MonthlyTransactions stored procedure"""
    
    sp_sql = """
    CREATE DEFINER=`root`@`localhost` PROCEDURE `Finance_MonthlyTransactions`(
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.execute("DROP PROCEDURE IF EXISTS Finance_MonthlyTransactions")
            print("✓ Dropped existing Finance_MonthlyTransactions procedure (if any)")
            
            # Create the new procedure
            cursor.execute(sp_sql)
            print("✓ Successfully created Finance_MonthlyTransactions stored procedure")
...
if __name__ == '__main__':
    success = create_finance_monthlytransactions_sp()
